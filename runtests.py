...
if __name__ == "__main__":
  ...
  parser.add_argument("-i", "--integration-tests", help="run integration tests", action="store_true")
  parser.add_argument(
    "-v",
    "--verbose",
    default=1,
  ...
  if args.integration_tests:
    if args.data_dir is None:
      raise ValueError("Need data directory! Consult tests/fetch_test_data.sh")

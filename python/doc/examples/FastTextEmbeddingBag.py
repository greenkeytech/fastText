...
if __name__ == "__main__":
  ...
  for _ in range(num_lines):
    words = [random_word(random.randint(1, 10)) for _ in range(random.randint(15, 25))]
  ...
  print(
    "Avg. {:2.5f} seconds to build embeddings for {} lines with a total of {} words.".format(
      total_seconds, num_lines, total_words
    )
  )
